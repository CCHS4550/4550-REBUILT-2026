...
public class TalonFXConfigEquality {
    ...
    public static boolean isEqual(Slot0Configs a, Slot0Configs b) {
        boolean val = MathUtil.isNear(a.kP, b.kP, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(MotorOutputConfigs a, MotorOutputConfigs b) {
        boolean val = a.Inverted.value == b.Inverted.value
                ...
                && MathUtil.isNear(a.DutyCycleNeutralDeadband, b.DutyCycleNeutralDeadband, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.PeakForwardDutyCycle, b.PeakForwardDutyCycle, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.PeakReverseDutyCycle, b.PeakReverseDutyCycle, TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(CurrentLimitsConfigs a, CurrentLimitsConfigs b) {
        boolean val = MathUtil.isNear(a.StatorCurrentLimit, b.StatorCurrentLimit, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(VoltageConfigs a, VoltageConfigs b) {
        boolean val = MathUtil.isNear(a.SupplyVoltageTimeConstant, b.SupplyVoltageTimeConstant, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(TorqueCurrentConfigs a, TorqueCurrentConfigs b) {
        boolean val = MathUtil.isNear(a.PeakForwardTorqueCurrent, b.PeakForwardTorqueCurrent, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.PeakReverseTorqueCurrent, b.PeakReverseTorqueCurrent, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.TorqueNeutralDeadband, b.TorqueNeutralDeadband, TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(FeedbackConfigs a, FeedbackConfigs b) {
        boolean val = MathUtil.isNear(a.FeedbackRotorOffset, b.FeedbackRotorOffset, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.SensorToMechanismRatio, b.SensorToMechanismRatio, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(OpenLoopRampsConfigs a, OpenLoopRampsConfigs b) {
        boolean val = MathUtil.isNear(
                        a.DutyCycleOpenLoopRampPeriod, b.DutyCycleOpenLoopRampPeriod, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.VoltageOpenLoopRampPeriod, b.VoltageOpenLoopRampPeriod, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.TorqueOpenLoopRampPeriod, b.TorqueOpenLoopRampPeriod, TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(ClosedLoopRampsConfigs a, ClosedLoopRampsConfigs b) {
        boolean val = MathUtil.isNear(
                        a.DutyCycleClosedLoopRampPeriod, b.DutyCycleClosedLoopRampPeriod, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.VoltageClosedLoopRampPeriod, b.VoltageClosedLoopRampPeriod, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.TorqueClosedLoopRampPeriod, b.TorqueClosedLoopRampPeriod, TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(HardwareLimitSwitchConfigs a, HardwareLimitSwitchConfigs b) {
        boolean val = a.ForwardLimitAutosetPositionEnable == b.ForwardLimitAutosetPositionEnable
                ...
                && MathUtil.isNear(
                        a.ForwardLimitAutosetPositionValue, b.ForwardLimitAutosetPositionValue, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(
                        a.ReverseLimitAutosetPositionValue, b.ReverseLimitAutosetPositionValue, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(SoftwareLimitSwitchConfigs a, SoftwareLimitSwitchConfigs b) {
        boolean val = MathUtil.isNear(a.ForwardSoftLimitThreshold, b.ForwardSoftLimitThreshold, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.ReverseSoftLimitThreshold, b.ReverseSoftLimitThreshold, TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
        boolean val = MathUtil.isNear(a.MotionMagicAcceleration, b.MotionMagicAcceleration, TALON_CONFIG_EPSILON)
                && MathUtil.isNear(a.MotionMagicCruiseVelocity, b.MotionMagicCruiseVelocity, TALON_CONFIG_EPSILON)
