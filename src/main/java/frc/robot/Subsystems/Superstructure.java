...
public class Superstructure extends SubsystemBase{
    ...
    public Superstructure(SwerveSubsystem swerveSubsystem, Intake intake, Kicker kicker, Turret turret, Agitator agitator){
    ...
    public void setWantedSuperstructureState(WantedSuperstructureState wantedState, boolean INTAKE_ACTIVE){
