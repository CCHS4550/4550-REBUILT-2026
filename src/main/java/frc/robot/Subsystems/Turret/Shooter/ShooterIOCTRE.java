...
public class ShooterIOCTRE implements ShooterIO {
    ...
    public ShooterIOCTRE (BruinRobotConfig bruinRobotConfig){
        shooterMotor = new TalonFX (bruinRobotConfig.SHOOTER_MOTOR.getDeviceNumber(), bruinRobotConfig.SHOOTER_MOTOR.getBus());
    ...
    public void updateInputs (ShooterIOInputs inputs){
        BaseStatusSignal.refreshAll(shooterAppliedVoltage, shooterSupplyCurrent, shooterStatorCurrent, shooterVelocityRotationsPerSec, shooterAccelerationRotationsPerSecSquared, shooterMotorTemperature);
        ...
        inputs.shooterVelocityRadPerSec = Units.rotationsToRadians(shooterVelocityRotationsPerSec.getValueAsDouble());
        inputs.shooterAccelRadPerSecSquared = Units.rotationsToRadians(shooterAccelerationRotationsPerSecSquared.getValueAsDouble());
    }
    ...
    public void setRadPerSec (double radPerSec){
        shooterMotor.setControl(motionMagicVelocityVoltage.withVelocity(Units.radiansToRotations(radPerSec)));
    }

    @Override
    public void setRotPerSec (double rotPerSec){
