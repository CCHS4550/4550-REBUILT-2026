...
public class AgitatorIOCTRE implements AgitatorIO {
        ...
        private final StatusSignal<AngularVelocity> agitatorVelocityagitatorsPerSec;
        private final StatusSignal<AngularAcceleration> agitatorAccelerationagitatorsPerSecSquared;
